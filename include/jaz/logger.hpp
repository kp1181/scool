...
namespace jaz {
  ...
  public:
      ...
      std::ostream& debug(const std::string& who = "") {
      ...
      std::ostream& info(const std::string& who = "") {
      ...
      std::ostream& warn(const std::string& who = "") {
      ...
      std::ostream& error(const std::string& who = "") {
          os_ << m_time__() << " ERROR ";
          if (!who.empty()) os_ << who << ": ";
          return os_;
      } // error
